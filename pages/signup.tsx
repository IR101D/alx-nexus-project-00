...
export default function SignUpPage() {
  ...
  const validateForm = (): boolean => {
    ...
    if (!formData.agreeToTerms) {
      newErrors.agreeToTermsAlert = 'You must agree to the terms and conditions';
    }
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-600">
            Or{' '}
            <Link href="/signin" className="font-medium text-[#B88E2F] hover:text-[#A67C2A]">
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                <input
                  ...
                  onChange={handleInputChange}
                  className="mt-1 h-4 w-4 text-[#B88E2F] focus:ring-[#B88E2F] border-gray-300 rounded"
                />
                <label htmlFor="agreeToTerms" className="ml-2 block text-sm text-gray-900">
                  I agree to the{' '}
                  <Link href="/terms" className="text-[#B88E2F] hover:text-[#A67C2A]">
                    Terms and Conditions
                  </Link>{' '}
                  and{' '}
                  <Link href="/privacy" className="text-[#B88E2F] hover:text-[#A67C2A]">
                    Privacy Policy
                  </Link>
                </label>
              </div>
              ...
              <div className="flex items-start">
                ...
                <label htmlFor="newsletter" className="ml-2 block text-sm text-gray-900">
                  Send me special offers, styling tips, and furniture trends
                </label>
              </div>
            </div>
          ...
          <div className="mt-8 p-4 bg-gray-50 rounded-lg">
            <h3 className="text-sm font-medium text-gray-900 mb-2">Benefits of creating an account:</h3>
